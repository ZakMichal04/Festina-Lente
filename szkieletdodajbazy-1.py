...
PLANK_THRESHOLDS_45_DEGREE = {
    "Biodro":   (155, 195, "Biodra za nisko lub za wysoko! Wyprostuj biodra."),
...
class MowcaBledow(threading.Thread):
    ...
    """
    def __init__(self, min_odstep=3.0, cooldown=7.0, rate=165):
        super().__init__(daemon=True)
...
def main():
    ...
    parser.add_argument("--tts-odstep",type=float,default=3.0,
    ...
    rejestrator = baza.RejestratorSerii() # Łódzki rejestrator do zapisu serii do bazy
    print(f"[BAZA]: Nowy trening, id = {rejestrator.id_treningu}")
        ...
        if frame_count % args.skip == 0:
            ...
            if results and results[0].keypoints is not None:
                ...
                if kpts_xy is not None and kpts_conf is not None and kpts_xy.shape[0] > 0:
                    ...
                    rejestrator.update(plank, len(smoothed_errors) == 0, t0)
    ...
    rejestrator.zakoncz() #zamknięcie bazy
